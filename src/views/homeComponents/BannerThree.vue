<template>
  <div class="warehouse-management">
    <div class="content">
      ...
      <div class="center">
        <img src="@/assets/banner3-2.png" alt="">
      </div>
      <div class="bottom-banner-3">
        <el-row :gutter="20">
