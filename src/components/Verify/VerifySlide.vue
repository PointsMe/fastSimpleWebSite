  ...
  methods: {
    ...
    // 鼠标松开
      ...
      if (this.status && this.isEnd == false) {
        ...
        checkCaptchaApi(data)
          .then((res) => {
            console.log("checkCaptchaApi===>", res);
            if (res.code == 20000) {
              ...
              setTimeout(() => {
                ...
                this.$parent.$emit("success", this.backToken);
              }, 1000);
            } else {
              ...
              this.tipWords = this.$t("verifyError");
              setTimeout(() => {
                this.tipWords = "";
              }, 1000);
            }
